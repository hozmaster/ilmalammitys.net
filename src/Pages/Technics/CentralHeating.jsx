...
export const CentralHeating = () => <div>
    <Header style={{marginTop: "2em"}} as={"h3"}> Lämmönjakeskus </Header>

    <Container textAlign='justified'> Kaukolämpöön kiinnitetyt taloudet tarvitsevat lämmityksen lisäksi lämmönjakokeskuksen joka huolehtii
        lämpimän veden lämmityksestä ja joka välittää kulloinkin ajankohtaan sopivan määrän kaukolämpöä
        ilmalämmityslaitteen
